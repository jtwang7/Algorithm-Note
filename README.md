...
- [x] [50. Pow(x,n)](https://leetcode-cn.com/problems/powx-n/description/)
- [x] [55. 跳跃游戏](https://leetcode-cn.com/problems/jump-game/description/)
- [x] [56. 合并区间](https://leetcode-cn.com/problems/merge-intervals/description/)
- [x] [60. 第 k 个排列](https://leetcode-cn.com/problems/permutation-sequence/description/)
- [x] [61. 旋转链表](https://leetcode-cn.com/problems/rotate-list/description/)
- [ ] [62. 不同路径]()
- [ ] [73. 矩阵置零]()
- [ ] [75. 颜色分类]()
- [ ] [78. 子集]()
